        ...
        <div className="container">
          <div className="columns">
            <div className="column is-two-fifths">
              <img
                src="https://colorlib.com/preview/theme/instylr/img/intro-img.jpg"
            ...
            <div className="column">
              <div className="cover">
                ...
                <div className="title is-size-3 is-spaced">
                  "I firmly believe that with the right footwear one can rule
                  the world."
                </div>
                ...
                <p className="subtitle is-size-6  has-text-grey">
                  ...
                  malesuada. In arcu justo, sagittis consequat pulvinar quis,
                  pretium quis massa. Vestibulum nec nibh eu nisi rutrum
                  iaculis. Pellentesque placerat sit amet leo in vestibu-lum.
